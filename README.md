...
Chaining twelve dual-profile selectors back-to-back (five NIS-threshold
...
combination stage, then a floatreset5 tighter-FLOAT-reset stage) extends
this further to **58.90% -> 66.60%** (**+3,566.9 m**, **+7.70 pp**). Each later stage
...
iono-free linear combination candidate), and +0.12 pp (floatreset5
stage 12, replacing stage-11 FLOAT segments with a tighter-reset
candidate). Gap to the PPC2024 public second-place reference (77.6%)
narrows from 18.70 pp at reset10 to 11.00 pp after stage 12. See

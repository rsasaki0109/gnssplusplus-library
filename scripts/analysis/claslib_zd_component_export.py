    ...
    output.update(
        {
            ...
            "code_bias_ref_week": first_present(row, ("code_bias_ref_week", "code_bias_reference_week")),
            "code_bias_ref_tow": first_present(row, ("code_bias_ref_tow", "code_bias_reference_tow")),

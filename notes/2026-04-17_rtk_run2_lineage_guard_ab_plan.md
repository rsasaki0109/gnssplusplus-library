...
```bash
cd rtklib_v2_rtk_ws/gnssplusplus-library
...
./build/apps/gnss_solve \
  --rover datasets/PPC-Dataset-data/tokyo/run2/rover.obs \
  --base  datasets/PPC-Dataset-data/tokyo/run2/base.obs \
  --nav   datasets/PPC-Dataset-data/tokyo/run2/base.nav \
...
```bash
./build/apps/gnss_solve \
  --rover datasets/PPC-Dataset-data/tokyo/run1/rover.obs \
  --base  datasets/PPC-Dataset-data/tokyo/run1/base.obs \
  --nav   datasets/PPC-Dataset-data/tokyo/run1/base.nav \
  --mode kinematic --preset low-cost --no-arfilter --no-wide-lane \
  --ratio 2.0 --max-postfix-rms 1.0 \
  --min-hold-count 1 --hold-ratio-threshold 1.0 \
  --glonass-ar autocal --max-hold-div 8 \
...
```bash
./build/apps/gnss_solve \
  --rover datasets/PPC-Dataset-data/tokyo/run3/rover.obs \
  --base  datasets/PPC-Dataset-data/tokyo/run3/base.obs \
  --nav   datasets/PPC-Dataset-data/tokyo/run3/base.nav \
  --mode kinematic --preset low-cost --no-arfilter --no-wide-lane \
  --ratio 2.0 --max-postfix-rms 1.0 \
  --min-hold-count 1 --hold-ratio-threshold 1.0 \
  --glonass-ar autocal --max-hold-div 8 \

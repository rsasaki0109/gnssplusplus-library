...
// MRTKLIB tidal displacement oracle. `options` uses tidedisp() bits
// (1=solid, 2=ocean loading, 4=pole); `ocean_loading` is the optional
// 66-value BLQ record in constituent-major order.
